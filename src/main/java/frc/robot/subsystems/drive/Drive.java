...
public class Drive extends SubsystemBase {
  private static final double MAX_LINEAR_SPEED = Constants.MAX_VELOCITY_METERS_PER_SECOND;
  private static final double TRACK_WIDTH_X = Constants.DRIVETRAIN_TRACKWIDTH_METERS;
  private static final double TRACK_WIDTH_Y = Constants.DRIVETRAIN_WHEELBASE_METERS;
